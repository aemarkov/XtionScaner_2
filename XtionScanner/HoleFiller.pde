...
public void HoleFiller(PointCloud oldCloud, PointCloud newCloud)
{
...
public void FillNewCloudWithOldCloud(PointCloud oldCloud, PointCloud newCloud)
{
...
public ArrayList<HoleLine> FindHoles(PointCloud cloud)
{
...
// Залатываем все дыры
public void FillHoles(ArrayList<HoleLine> holes, PointCloud cloud)
{
